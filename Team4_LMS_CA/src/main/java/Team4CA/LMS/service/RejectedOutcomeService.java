...
@Service
public class RejectedOutcomeService {
	
	private JavaMailSender javaMailSender;
	
	@Autowired
	public RejectedOutcomeService(JavaMailSender javaMailSender) {
	...
	public void sendNotification(Employee emp) throws MailException {
		...
		mail.setText("Leave Request Status: Rejected. Login for more details: http://localhost:8080/");
